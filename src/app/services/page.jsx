    ...
    <div style={{
      ...
      <div>
        <div className="rounded-t-3xl md:rounded-t-[4.5rem] min-h-screen bg-slate-100 lg:px-32 md:px-16 px-8">
          <div className="md:grid md:grid-cols-6 flex flex-col items-center md:gap-16 gap:8 pt-16">
            <div className="col-span-2">
              <Image src={"/images/services/web.png"} alt="Web Development Image" width={350} height={350} />
            </div>
            <div className="col-span-4 p-4">
              <div className="py-8">
                <span className="text-black text-3xl tracking-wide font-bold underline-main">Web Development</span>
              </div>
          ...
          <div className="flex flex-col md:grid md:grid-cols-6 items-center md:gap-16 gap-8 py-8">
              ...
              <div className="md:col-span-4 order-2 md:order-1 p-4">
                  <div className="py-8">
                    <span className="text-black text-3xl tracking-wide font-bold underline-main">App Development</span>
                  </div>
          ...
          <div className="md:grid md:grid-cols-6 flex flex-col items-center md:gap-16 gap:8 py-8">
            ...
            <div className="col-span-4 p-4">
              <div className="py-8">
                <span className="text-black text-3xl tracking-wide font-bold underline-main">Logo Design</span>
              </div>
          ...
          <div className="md:grid md:grid-cols-6 flex flex-col items-center md:gap-16 gap:8 pb-16 pt-8">
            ...
            <div className="md:col-span-4 order-2 md:order-1 p-4">
              <div className="py-8">
                <span className="text-black text-3xl tracking-wide font-bold underline-main">SEO (Search Engine Optimization)</span>
              </div>
