    ...
    return (
      <div>
        <div className="flex flex-col bg-white rounded-3xl overflow-hidden shadow-lg hover:bg-opacity-80 group"> 
          <div className="flex flex-col h-56 items-center justify-center bg-sky-100 mx-4 mt-4 px-8 pt-4 pb-8 rounded-2xl relative">
            <Image className="group-hover:drop-shadow-2xl ease-linear duration-200" src={logo} height={180} width={180} />
